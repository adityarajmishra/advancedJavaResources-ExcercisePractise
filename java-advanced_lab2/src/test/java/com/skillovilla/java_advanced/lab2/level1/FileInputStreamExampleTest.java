...
class FileInputStreamExampleTest {
    ...
    void setUp() throws Exception {
        simpleFileReaderClass = Class.forName("com.skillovilla.java_advanced.lab2.level1.FileInputStreamExample");
    ...
    void testReadFileContent() throws Exception {
        Method readFileContentMethod = simpleFileReaderClass.getMethod("readFileContent", String.class);

        String content = (String) readFileContentMethod.invoke(simpleFileReaderInstance, testFilePath.toString());
